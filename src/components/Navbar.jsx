      ...
      <Container>
        ...
        <Nav menuOpen={menuOpen}>
          <ul>
            ...
            <li><NavLinkStyled to="/corporates" onClick={() => setMenuOpen(false)}>CORP TRAININGS</NavLinkStyled></li>
            <li><NavLinkStyled to="/parteners" onClick={()=> setMenuOpen(false)}>PARTNER US</NavLinkStyled></li>
