...
const partnersData = [
  {
    id: 1,
    name: "Bhaskar Margaj",
    pose: "(CEO), Professor of Practice (Pimpri-Chinchwad University)",
  ...
  {
    id: 5,
    name: "Dr Anand Wadadekar",
    pose: "Strategist- Learning and Academic LEARNEDGE SOLUTIONS PVT.LTD",
    about: "Dr. Anand Wadadekar has been in the education, learning, training sector for 16+ yearshaving worked in multiple areas for Online/Offline Learning, Digital Learning Solutions, Learning Development, Trainingvelopment, Project Management, Academics, Entrepreneurship, Teaching, Consulting,Career Counselling. With strong career counselling competence developed over 16+ years,have developed excellent command over student psychology and career planning. He has earned Doctor of Philosophy (Ph.D.) in Education Economics. A Commerce graduate,Post Graduate in Economics, Post Graduate in Education, Post Graduate in Finance & Banking from Symbiosis Institute of Business Management (SIBM) Pune and Diploma in Information Technology from C-DAC. Certified Learning and Development Manager from VSkills and Aon HR.",
    image: "images/OurTeam/Anand.webp"
  }
];
